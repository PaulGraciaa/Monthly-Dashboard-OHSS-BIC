...
<head>
    ...
    <title><?php echo $page_title ?? 'Surveillance Management'; ?> - OHSS</title>
            ...
            <div class="max-w-7xl mx-auto px-4 py-2">
                <nav class="flex space-x-4">
                    ...
                    <a href="index.php" class="bg-red-700 text-white px-3 py-2 rounded-md text-sm font-medium">
                        <i class="fas fa-eye mr-1"></i> Surveillance
                    </a>
                    <a href="overall_performance.php" class="text-red-100 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                        <i class="fas fa-chart-line mr-1"></i> Overall Performance
                    </a>
                    <a href="improvements_progress.php" class="text-red-100 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                        <i class="fas fa-project-diagram mr-1"></i> Improvements Progress
                    </a>
                    <a href="cctv_system.php" class="text-red-100 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                        <i class="fas fa-video mr-1"></i> CCTV System
                    </a>
                    <a href="isss_software.php" class="text-red-100 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                        <i class="fas fa-laptop mr-1"></i> ISSS Software
                    </a>
                    <a href="qr_scanned.php" class="text-red-100 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                        <i class="fas fa-qrcode mr-1"></i> QR Scanned
                    </a>
                    <a href="security_patrol.php" class="text-red-100 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                        <i class="fas fa-shield-alt mr-1"></i> Security Patrol
                    </a>
