...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($category)) {
        ...
        $query = "UPDATE fire_safety_emergency_activation SET category = ?, jan_value = ?, feb_value = ?, mar_value = ?, apr_value = ?, may_value = ?, jun_value = ?, jul_value = ?, aug_value = ?, sep_value = ?, oct_value = ?, nov_value = ?, dec_value = ?, grand_total = ?, display_order = ?, is_active = ? WHERE id = ?";
        $stmt = mysqli_prepare($conn, $query);
        mysqli_stmt_bind_param($stmt, "siiiiiiiiiiiiiiii", $category, $jan_value, $feb_value, $mar_value, $apr_value, $may_value, $jun_value, $jul_value, $aug_value, $sep_value, $oct_value, $nov_value, $dec_value, $grand_total, $display_order, $is_active, $id);
...
<head>
    ...
    <title>Edit Emergency Activation</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Edit Emergency Activation</h1>
                        ...
                        <form method="POST">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="category" name="category" value="<?= htmlspecialchars($data['category']) ?>" required>
                            ...
                            <div class="row">
                                <div class="col-md-2 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="jan_value" name="jan_value" value="<?= $data['jan_value'] ?>" min="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="feb_value" class="form-label">February</label>
                                    <input type="number" class="form-control" id="feb_value" name="feb_value" value="<?= $data['feb_value'] ?>" min="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="mar_value" class="form-label">March</label>
                                    <input type="number" class="form-control" id="mar_value" name="mar_value" value="<?= $data['mar_value'] ?>" min="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="apr_value" class="form-label">April</label>
                                    <input type="number" class="form-control" id="apr_value" name="apr_value" value="<?= $data['apr_value'] ?>" min="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="may_value" class="form-label">May</label>
                                    <input type="number" class="form-control" id="may_value" name="may_value" value="<?= $data['may_value'] ?>" min="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="jun_value" class="form-label">June</label>
                                    <input type="number" class="form-control" id="jun_value" name="jun_value" value="<?= $data['jun_value'] ?>" min="0">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-2 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="jul_value" name="jul_value" value="<?= $data['jul_value'] ?>" min="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="aug_value" class="form-label">August</label>
                                    <input type="number" class="form-control" id="aug_value" name="aug_value" value="<?= $data['aug_value'] ?>" min="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="sep_value" class="form-label">September</label>
                                    <input type="number" class="form-control" id="sep_value" name="sep_value" value="<?= $data['sep_value'] ?>" min="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="oct_value" class="form-label">October</label>
                                    <input type="number" class="form-control" id="oct_value" name="oct_value" value="<?= $data['oct_value'] ?>" min="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="nov_value" class="form-label">November</label>
                                    <input type="number" class="form-control" id="nov_value" name="nov_value" value="<?= $data['nov_value'] ?>" min="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="dec_value" class="form-label">December</label>
                                    <input type="number" class="form-control" id="dec_value" name="dec_value" value="<?= $data['dec_value'] ?>" min="0">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" value="<?= $data['grand_total'] ?>" readonly>
