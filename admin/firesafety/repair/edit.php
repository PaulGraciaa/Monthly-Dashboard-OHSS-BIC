...
<head>
    ...
    <title>Edit Fire Safety Repair Impairment</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Edit Fire Safety Repair Impairment</h1>
                        ...
                        <form method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="repair_count" name="repair_count" value="<?= $data['repair_count'] ?>" min="0">
                                </div>
                                <div class="col-md-3 mb-3">
