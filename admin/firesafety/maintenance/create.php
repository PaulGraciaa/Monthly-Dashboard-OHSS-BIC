...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($location)) {
        ...
        $query = "INSERT INTO fire_equipment_maintenance (serial_number, maintenance_date, location, display_order, is_active, created_by) VALUES (?, ?, ?, ?, ?, ?)";
        $stmt = mysqli_prepare($conn, $query);
        mysqli_stmt_bind_param($stmt, "issiii", $serial_number, $maintenance_date, $location, $display_order, $is_active, $created_by);
...
<head>
    ...
    <title>Tambah Fire Equipment Maintenance</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Tambah Fire Equipment Maintenance</h1>
                        ...
                        <form method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="maintenance_date" name="maintenance_date" value="<?= isset($_POST['maintenance_date']) ? $_POST['maintenance_date'] : '' ?>" required>
                                </div>
                                <div class="col-md-3 mb-3">
