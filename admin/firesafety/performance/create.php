...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($summary_text)) {
        ...
        $query = "INSERT INTO fire_safety_performance (summary_text, display_order, is_active, created_by) VALUES (?, ?, ?, ?)";
        $stmt = mysqli_prepare($conn, $query);
        mysqli_stmt_bind_param($stmt, "siii", $summary_text, $display_order, $is_active, $created_by);
...
<head>
    ...
    <title>Tambah Fire Safety Performance Summary</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Tambah Fire Safety Performance Summary</h1>
                    ...
                    <div class="card-body">
                        <form method="POST">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="summary_text" name="summary_text" rows="4" required><?= isset($_POST['summary_text']) ? htmlspecialchars($_POST['summary_text']) : '' ?></textarea>
