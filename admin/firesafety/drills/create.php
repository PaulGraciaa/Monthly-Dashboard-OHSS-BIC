...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($location) || empty($subject)) {
        ...
        $query = "INSERT INTO fire_safety_drills (serial_number, drill_date, location, subject, drill_type, display_order, is_active, created_by) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = mysqli_prepare($conn, $query);
        mysqli_stmt_bind_param($stmt, "issssiii", $serial_number, $drill_date, $location, $subject, $drill_type, $display_order, $is_active, $created_by);
...
<head>
    ...
    <title>Tambah Fire Safety Drills</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Tambah Fire Safety Drills</h1>
                        ...
                        <form method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="drill_date" name="drill_date" value="<?= isset($_POST['drill_date']) ? $_POST['drill_date'] : '' ?>" required>
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select class="form-select" id="drill_type" name="drill_type" required>
                                        ...
                                        <option value="drill" <?= (isset($_POST['drill_type']) && $_POST['drill_type'] == 'drill') ? 'selected' : '' ?>>Drill</option>
                                        <option value="training" <?= (isset($_POST['drill_type']) && $_POST['drill_type'] == 'training') ? 'selected' : '' ?>>Training</option>
                                    </select>
                                </div>
                                <div class="col-md-3 mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="subject" name="subject" value="<?= isset($_POST['subject']) ? htmlspecialchars($_POST['subject']) : '' ?>" required>
