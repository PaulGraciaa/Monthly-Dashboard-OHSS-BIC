...
<head>
    ...
    <title>Edit Fire Equipment Statistics</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Edit Fire Equipment Statistics</h1>
                        ...
                        <form method="POST">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="equipment_type" name="equipment_type" value="<?= htmlspecialchars($data['equipment_type']) ?>" required>
                            ...
                            <div class="row">
                                <div class="col-md-2 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="jan_count" name="jan_count" value="<?= $data['jan_count'] ?>" min="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="feb_count" class="form-label">February</label>
                                    <input type="number" class="form-control" id="feb_count" name="feb_count" value="<?= $data['feb_count'] ?>" min="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="mar_count" class="form-label">March</label>
                                    <input type="number" class="form-control" id="mar_count" name="mar_count" value="<?= $data['mar_count'] ?>" min="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="apr_count" class="form-label">April</label>
                                    <input type="number" class="form-control" id="apr_count" name="apr_count" value="<?= $data['apr_count'] ?>" min="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="may_count" class="form-label">May</label>
                                    <input type="number" class="form-control" id="may_count" name="may_count" value="<?= $data['may_count'] ?>" min="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="jun_count" class="form-label">June</label>
                                    <input type="number" class="form-control" id="jun_count" name="jun_count" value="<?= $data['jun_count'] ?>" min="0">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-2 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="jul_count" name="jul_count" value="<?= $data['jul_count'] ?>" min="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="aug_count" class="form-label">August</label>
                                    <input type="number" class="form-control" id="aug_count" name="aug_count" value="<?= $data['aug_count'] ?>" min="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="sep_count" class="form-label">September</label>
                                    <input type="number" class="form-control" id="sep_count" name="sep_count" value="<?= $data['sep_count'] ?>" min="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="oct_count" class="form-label">October</label>
                                    <input type="number" class="form-control" id="oct_count" name="oct_count" value="<?= $data['oct_count'] ?>" min="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="nov_count" class="form-label">November</label>
                                    <input type="number" class="form-control" id="nov_count" name="nov_count" value="<?= $data['nov_count'] ?>" min="0">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="dec_count" class="form-label">December</label>
                                    <input type="number" class="form-control" id="dec_count" name="dec_count" value="<?= $data['dec_count'] ?>" min="0">
                                </div>
                            </div>
