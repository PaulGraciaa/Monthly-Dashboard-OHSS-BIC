    ...
    <main class="flex-1 animate-fade-in">
        <div class="max-w-7xl mx-auto px-6 py-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <a href="security/personnel.php" class="module-card group block bg-white rounded-xl shadow-sm p-6 hover:shadow-xl transition-all duration-300 border border-gray-100">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">Personnel, Gallery</p>
                        </div>
                    </div>
                </a>
                ...
                <a href="firesafety/emergency.php" class="module-card group block bg-white rounded-xl shadow-sm p-6 hover:shadow-xl transition-all duration-300 border border-gray-100">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <p class="text-xs font-medium text-gray-400 uppercase tracking-wide">Module</p>
                            <h3 class="text-lg font-bold text-gray-900 mt-1">Fire Safety Management</h3>
                            <p class="text-sm text-gray-500 mt-1">Performance, Enforcement, Drills</p>
                        </div>
                    </div>
                </a>
            </div>
