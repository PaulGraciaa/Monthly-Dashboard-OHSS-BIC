...
// Get Fire Safety content
$firesafetyContent = $pdo->query("SELECT * FROM firesafety_content WHERE is_active = 1 ORDER BY display_order")->fetchAll();
?>
<!DOCTYPE html>
<html lang="id">
<head>
  ...
  <title>Fire Safety - OHSS Dashboard</title>
...
<div id="loader-bg" style="position:fixed;z-index:9999;top:0;left:0;right:0;bottom:0;background:#f4f7fa;display:flex;align-items:center;justify-content:center;transition:opacity 0.5s;">
  ...
  <header class="bg-header-footer-bg text-white px-2 py-1 flex items-center justify-between mb-3 min-h-0 h-12 relative">
    ...
    <div class="text-right hidden sm:block">
      <div class="text-sm font-semibold leading-tight"><strong>Fire Safety Management</strong></div>
  ...
  <main class="main-content flex-1 fadein">
    <div class="container mx-auto px-4 max-w-7xl">
      <!-- Page Header -->
      <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Fire Safety Management</h1>
        <p class="text-gray-600">Comprehensive fire safety monitoring and emergency response system</p>
      </div>

      <!-- Fire Safety Content Grid -->
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
        <?php foreach ($firesafetyContent as $content): ?>
        <div class="bg-white rounded-xl shadow-md border border-red-100 p-6 hover:shadow-lg transition-shadow">
      ...
      <div class="mt-8 bg-white rounded-xl shadow-md border border-red-100 p-6">
        <h2 class="text-2xl font-bold text-gray-900 mb-6">Fire Safety Statistics</h2>
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div class="text-center">
            <div class="text-3xl font-bold text-red-600 mb-2">100%</div>
            <div class="text-gray-600">Equipment Ready</div>
          </div>
          <div class="text-center">
            <div class="text-3xl font-bold text-green-600 mb-2">12</div>
            <div class="text-gray-600">Monthly Drills</div>
          </div>
          <div class="text-center">
            <div class="text-3xl font-bold text-yellow-600 mb-2">0</div>
            <div class="text-gray-600">Fire Incidents</div>
          </div>
          <div class="text-center">
            <div class="text-3xl font-bold text-blue-600 mb-2">50+</div>
            <div class="text-gray-600">Trained Personnel</div>
          </div>
        </div>
      </div>
      ...
      <div class="mt-8 bg-red-50 rounded-xl border border-red-200 p-6">
        <h2 class="text-2xl font-bold text-red-800 mb-4">Emergency Contact</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div class="text-center">
            <div class="text-2xl font-bold text-red-600 mb-2">Fire Department</div>
            <div class="text-lg text-gray-700">113</div>
          </div>
          <div class="text-center">
            <div class="text-2xl font-bold text-red-600 mb-2">Emergency Response</div>
            <div class="text-lg text-gray-700">+62-778-123456</div>
          </div>
          <div class="text-center">
            <div class="text-2xl font-bold text-red-600 mb-2">Security Control</div>
            <div class="text-lg text-gray-700">+62-778-654321</div>
          </div>
        </div>
      </div>
    </div>
