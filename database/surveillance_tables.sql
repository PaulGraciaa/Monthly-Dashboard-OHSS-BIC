-- Tabel untuk Surveillance System Overall Performance
CREATE TABLE IF NOT EXISTS `surveillance_overall_performance` (
...
-- Insert data awal berdasarkan data yang ada di HTML
INSERT INTO `surveillance_overall_performance` (`indicator`, `current_month`, `cumulative`) VALUES
...
-- Tabel untuk Improvements Project Progress
CREATE TABLE IF NOT EXISTS `surveillance_improvements_progress` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Insert data awal untuk Improvements Project Progress
INSERT INTO `surveillance_improvements_progress` (`project_title`, `description`, `status`, `percentage`) VALUES
...
-- Insert data awal untuk CCTV System
INSERT INTO `surveillance_cctv_system` (`category`, `description`, `operational`, `non_operational`, `readiness_percentage`, `notes`) VALUES
...
-- Tabel untuk ISSS Software Utilization
CREATE TABLE IF NOT EXISTS `surveillance_isss_software` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Insert data awal untuk ISSS Software Utilization
INSERT INTO `surveillance_isss_software` (`metric_name`, `jan`, `feb`, `mar`, `apr`, `may`, `jun`, `jul`, `aug`, `sep`, `oct`, `nov`, `dec`) VALUES
...
-- Tabel untuk Security Team Patrol Performance
CREATE TABLE IF NOT EXISTS `surveillance_security_patrol` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Insert data awal untuk Security Team Patrol Performance
INSERT INTO `surveillance_security_patrol` (`team_name`, `jan`, `feb`, `mar`, `apr`, `may`, `jun`, `jul`, `aug`, `sep`, `oct`, `nov`, `dec`) VALUES
...
-- Tabel untuk Security Team Performance on QR Scanned
CREATE TABLE IF NOT EXISTS `surveillance_qr_scanned` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `team_name` varchar(255) NOT NULL,
  `jan` varchar(50) DEFAULT NULL,
  `feb` varchar(50) DEFAULT NULL,
...
-- Insert data awal untuk Security Team Performance on QR Scanned
INSERT INTO `surveillance_qr_scanned` (`team_name`, `jan`, `feb`, `mar`, `apr`, `may`, `jun`, `jul`, `aug`, `sep`, `oct`, `nov`, `dec`) VALUES
